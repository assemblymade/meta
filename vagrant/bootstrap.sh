...
su - vagrant <<-'EOF'
  ...
  DEV_POSTGRES_PORT=5432 bundle exec rake db:drop:all
  DEV_POSTGRES_PORT=5432 bundle exec rake db:create:all
  DEV_POSTGRES_PORT=5432 RAILS_ENV=test bundle exec rake db:create
  DEV_POSTGRES_PORT=5432 bundle exec rake db:schema:load
  DEV_POSTGRES_PORT=5432 bundle exec rake db:migrate
  DEV_POSTGRES_PORT=5432 bundle exec rake db:seed
EOF
