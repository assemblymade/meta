  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        return this.search_field_scale();
        // added by Pletcher
      } else if (this.get_search_text().length) {
        this.select_create_option(this.get_search_text());
      }
    };
    ...
    Chosen.prototype.show_create_option = function(terms) {
      ...
      terms = terms.replace(/[^\w-]+/g, '') // TODO: Clean up these additions/customizations
      create_option_html = $('<li class="create-option active-result"><a>' + this.create_option_text + '</a>: "@' + terms.toLowerCase() + '"</li>');
