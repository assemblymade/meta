...
module.exports = React.createClass({
      ...
      <div>
        ...
        <div className="discussion _p0">
          {{/*
            ...
            --- Comments are used below only to help identify sections. Delete whatever isn't useful.
          ...
          */}}
            ...
            {this.renderDiscussionHeader_Handoff()}
            {this.renderComments_Handoff()}
  ...
  renderDiscussionHeader_Handoff: function() {
    return (
      <div></div>
    );
  },

  renderComments_Handoff: function() {
    return (
