...
let IdeasNew = React.createClass({
  ...
  render() {
    return (
      <div className="sm-col-11 md-col-6 mx-auto mt4 mb4">
        <Tile>
          <div className="mt3 mb4 px4">
            ...
            <h4 className="mt0 mb0 regular gray-2 center">The community collaborates to build the best ideas into products.</h4>
